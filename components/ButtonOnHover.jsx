...
const ButtonOnHover = ({ text, color, icon }) => {
  return (
    <button
      ...
      } py-[10px] relative border-2 border-primary-color rounded-md tracking-wider leading-none overflow-hidden hover:text-white flex gap-[6px] justify-center items-center font-semibold uppercase w-max`}
    >
